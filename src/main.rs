...
fn main() {
    ...
    match subcommand.as_str() {
        ...
        "blur" => {
            ...
            let bluramount:f32 = args.remove(0).parse().expect("Failed to parse a number");
            // **OPTION**
            // Improve the blur implementation -- see the blur() function below
            blur(infile, outfile, bluramount);
        }
...
//Done
fn blur(infile: String, outfile: String, bluramount:f32) {
